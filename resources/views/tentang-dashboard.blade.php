...
">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md text-center">
            <div class="w-[220px] h-[220px] mx-auto mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mb-6"">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md">
            <h3 class="font-semibold text-lg mb-3">Sumber Data</h3>
        ...
        <div class="bg-white p-6 rounded-xl shadow-md">
            <h3 class="font-semibold text-lg mb-3">Program IP3K</h3>
            <p class="mb-4">Pembangunan 2021-2026</p>

            <div class="flex items-center gap-4 mb-4">
                <span>2021</span>
                <div class="flex-1 h-[6px] bg-blue-300 rounded-full relative">
            ...
            <h3 class="font-semibold text-lg mb-1">Kontak</h3>
