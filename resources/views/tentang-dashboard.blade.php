...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md text-center">
            ...
            <h3 class="font-bold text-lg mb-2">Monitoring</h3>
            <p>Memudahkan pemerintah dan masyarakat memantau progress pembangunan.</p>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-md text-center">
            ...
            <p>Menjadi dasar dalam pengambilan keputusan pemerintah.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mb-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md">
            <h3 class="font-bold text-lg mb-3">Sumber Data</h3>
        ...
        <div class="bg-white p-6 rounded-xl shadow-md">
            <h3 class="font-bold text-lg mb-3">Program IP3K</h3>
            <p class="mb-4">Pembangunan 2021-2026</p>

            <div class="flex items-center gap-4 mb-4">
                <span>2021</span>
                <div class="flex-1 h-1 bg-blue-300 rounded-full relative">
                    <span class="absolute left-0 -top-1 w-3 h-3 bg-blue-600 rounded-full"></span>
                    <span class="absolute left-1/2 -top-1 w-3 h-3 bg-blue-600 rounded-full"></span>
                    <span class="absolute right-0 -top-1 w-3 h-3 bg-blue-600 rounded-full"></span>
                </div>
                <span>2026</span>
            </div>

            <h3 class="font-bold text-lg mb-1">Kontak</h3>
            <p>Email: bappeda@sekadau.go.id</p>
            <p>Telp: +62857-0908-5762</p>
        </div>
